...
CTV: [["ZIP!","05:50","08:30",[
  ...
  ["ニュース7時台","06:50","07:05","news","news_crime"],
...
NBN: [
  ...
  ["ドデスカ!","06:00","08:30",[
    ...
    ["CMブロック","08:00","08:03","cm","cm"],
    ["ドデスカ!最終コーナー","08:03","08:30","news","news_local"],
  ]],
],
TVA: [
  ["朝のショッピング","05:30","06:00",[
    ["テレビショッピング","05:30","06:00","sponsor","sponsor"],
  ]],
  ["モーニングショップ","06:00","06:45",[
    ["テレビショッピング：美容家電","06:00","06:25","sponsor","sponsor"],
    ["CMブロック","06:25","06:28","cm","cm"],
    ["健康食品","06:28","06:45","sponsor","sponsor"],
  ]],
  ["おはスタ","06:45","07:05",[
    ["ゲーム最新情報","06:45","06:55","ent","ent_music"],
    ["CMブロック","06:55","06:58","cm","cm"],
    ["おはガールトレンド","06:58","07:05","ent","kids"],
  ]],
  ["シナぷしゅ","07:05","07:30",[["シナぷしゅ本編","07:05","07:30","other","kids"]]],
  ["ダイレクトテレショップ","07:30","08:30",[["健康器具特集","07:30","08:30","sponsor","sponsor"]]],
],
NHK: [
  ["おはよう日本","05:00","08:00",[
    ...
    ["経済・暮らし","07:45","07:55","news","news_economy"],
    ["気象・交通","07:55","08:00","weather","weather"],
  ]],
  ["連続テレビ小説","08:00","08:15",[["朝ドラ","08:00","08:15","ent","asadora"]]],
  ["気象情報","08:15","08:30",[["気象情報","08:15","08:30","weather","weather"]]],
],
NHKE: [
  ...
  ["Eテレ0655","06:25","06:30",[["0655","06:25","06:30","other","kids"]]],
  ["テレビ体操","06:30","06:40",[["テレビ体操","06:30","06:40","other","kids"]]],
  ["はなかっぱ","06:40","06:55",[["はなかっぱ","06:40","06:55","ent","kids"]]],
  ["みいつけた!","06:55","07:10",[["みいつけた！","06:55","07:10","ent","kids"]]],
  ["おかあさんといっしょ","07:10","07:35",[
    ["うたのコーナー","07:10","07:20","ent","kids"],
    ["ファンターネ！","07:20","07:30","ent","kids"],
    ["体操コーナー","07:30","07:35","ent","kids"],
  ]],
  ["ピタゴラスイッチ","07:35","07:45",[["ピタゴラスイッチ ミニ","07:35","07:45","other","kids"]]],
  ["コレナンデ商会","07:45","07:55",[["コレナンデ商会","07:45","07:55","ent","kids"]]],
  ["クックルン","07:55","08:30",[["クックルン","07:55","08:30","ent","kids"]]],
],
};
...
THK: [
  ...
  ["ニュースOne","16:40","19:30",[
    ...
    ["ニュースOne最終版","19:03","19:30","news","news_local"],
  ]],
],
CTV: [
  ["午後キャッチ","16:00","16:40",[
...
CBC: [["チャント！","15:49","19:30",[
  ...
  ["エンディング","18:50","19:00","ending","ending"],
  ["CMブロック","19:00","19:03","cm","cm"],
  ["チャント！最終版","19:03","19:30","news","news_local"],
]]],
NBN: [
  ["NBN午後","16:00","16:40",[
    ["午後ニュース","16:00","16:20","news","news_local"],
...
TVA: [
  ...
  ["ゆうがたサテライト","16:54","17:20",[
    ["マーケット速報","16:54","17:05","news","news_economy"],
    ["ビジネス特集","17:05","17:15","feature","feat_business"],
    ["天気","17:15","17:20","weather","weather"],
  ]],
  ["アニメタイム","17:20","17:50",[
    ["アニメ本編","17:20","17:48","ent","ent_drama"],
...
NHK: [
  ...
  ["NHKニュース19","19:00","19:30",[
    ["全国ニュース","19:00","19:20","news","news_politics"],
    ["気象情報","19:20","19:30","weather","weather"],
  ]],
],
NHKE: [
  ["Eテレ午後","16:00","16:40",[["子ども向け番組","16:00","16:40","other","kids"]]],
  ["いないいないばあっ!","16:40","16:55",[["いないいないばあっ！","16:40","16:55","ent","kids"]]],
  ["おかあさんといっしょ","16:55","17:20",[
    ["うた・体操","16:55","17:10","ent","kids"],
    ["ファンターネ！","17:10","17:20","ent","kids"],
  ]],
  ["みいつけた!","17:20","17:35",[["みいつけた！","17:20","17:35","ent","kids"]]],
  ["はなかっぱ","17:35","17:45",[["はなかっぱ","17:35","17:45","ent","kids"]]],
  ["クックルン","17:45","17:55",[["クックルン","17:45","17:55","ent","kids"]]],
  ["Eテレ1755","17:55","18:00",[["1755","17:55","18:00","other","kids"]]],
  ["沼にハマってきいてみた","18:00","18:30",[["沼ハマ","18:00","18:30","feature","feat_social"]]],
  ["天才てれびくん","18:30","19:00",[
    ["天才てれびくん hello,","18:30","18:55","ent","kids"],
    ["エンディング","18:55","19:00","ending","ending"],
  ]],
  ["Eテレ1900","19:00","19:30",[["Eテレ夜の番組","19:00","19:30","feature","feat_social"]]],
],
};
...
function getDailyMorn(date){ return buildDaily(MORN_TPL, date); }
...
function CornerModal({corner,cache,onClose}){
  ...
  const fmt=(v,isShare)=>v!=null?(isShare?v.toFixed(1):v.toFixed(2))+"%":"—";
  ...
  // Rival corners overlapping [sM, eM], with a stable key
    ...
    for(const sid of ST.map(s=>s.id)){
      ...
      for(const[pn,,,corners2] of progs){
        for(const cn of corners2){
          ...
          // stats over the OVERLAP window only (for right panel display)
          const ovS=Math.max(csM,sM),ovE=Math.min(ceM,eM);
  ...
  return <div onClick={onClose} style={{position:"fixed",inset:0,background:"rgba(0,0,0,0.45)",zIndex:200,display:"flex",alignItems:"center",justifyContent:"center",padding:16}}>
    <div onClick={e=>e.stopPropagation()} style={{background:"#fff",borderRadius:12,width:"100%",maxWidth:900,maxHeight:"92vh",display:"flex",flexDirection:"column",boxShadow:"0 20px 60px rgba(0,0,0,0.25)"}}>
      {/* Header */}
        ...
        <div style={{flex:"0 0 56%",display:"flex",flexDirection:"column",borderRight:"1px solid #F3F4F6",overflow:"hidden"}}>
          ...
          <div style={{display:"grid",gridTemplateColumns:"1fr 1fr 1fr 1fr",gap:6,padding:"10px 14px 8px",flexShrink:0}}>
            {[
              ...
              {lb:"視聴率 AVG",v:fmt(avgR,false),c:"#111827"},{lb:"視聴率 DIFF",v:dfR!=null?`${dfR>=0?"+":""}${dfR.toFixed(2)}%`:"—",c:dfR!=null?(dfR>=0?"#16A34A":"#DC2626"):"#9CA3AF"},
            ...
            <div style={{background:"#FAFBFC",borderRadius:8,padding:"10px 10px 6px",border:"1px solid #F3F4F6"}}>
              ...
              <div style={{display:"flex",flexWrap:"wrap",gap:8,marginBottom:8}}>
                ...
                {[...activeRivals].map(key=>{
                  const rv=rivals.find(r=>r.key===key);if(!rv)return null;
                  const rst=ST.find(s=>s.id===rv.sid);
                  return <div key={key} style={{display:"flex",alignItems:"center",gap:4}}>
                    <svg width="18" height="8"><line x1="0" y1="4" x2="18" y2="4" stroke={rst.c} strokeWidth="1.5" strokeDasharray="4,3"/></svg>
                    <span style={{fontSize:8.5,color:rst.c,fontFamily:"monospace",fontWeight:700}}>{rv.sid}</span>
                  </div>;
                })}
              </div>
...
export default function App(){
  ...
  const[aDate,setADate]=useState(ALL_DATES[0]);
